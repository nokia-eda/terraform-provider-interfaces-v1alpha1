...
const (
	create_rs_interface = "/apps/interfaces.eda.nokia.com/v1alpha1/namespaces/{namespace}/interfaces"
	read_rs_interface   = "/apps/interfaces.eda.nokia.com/v1alpha1/namespaces/{namespace}/interfaces/{name}"
	update_rs_interface = "/apps/interfaces.eda.nokia.com/v1alpha1/namespaces/{namespace}/interfaces/{name}"
	delete_rs_interface = "/apps/interfaces.eda.nokia.com/v1alpha1/namespaces/{namespace}/interfaces/{name}"
)
