...
package resource_interface_state
...
func InterfaceStateResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^InterfaceState$"), ""),
				},
				Default: stringdefault.StaticString("InterfaceState"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the InterfaceState",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
...
type InterfaceStateModel struct {
